...
//
//   testando() async {
//     final url = Uri.parse('https://laica.ifrn.edu.br/access-ng/log/test');
//
//     File? capturedImageFile;
//     if (_capturedImagePath != null) {
//       capturedImageFile = File(_capturedImagePath!);
//     }
//     Uint8List _bytes = await capturedImageFile!.readAsBytes();
